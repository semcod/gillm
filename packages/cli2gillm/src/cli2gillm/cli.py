...
from cli2gillm.shell import run_shell
from dsl2gillm.bus import dispatch, execute_dsl


def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="cli2gillm — shell for dsl2gillm")
    ...
    if cmd == "shell":
        return run_shell(default_file=default_file, json_out=args.json)
